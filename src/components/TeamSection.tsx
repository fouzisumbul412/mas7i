...
const teamMembers: TeamMember[] = [
  {
    ...
    description: 'Priya specializes in tech recruitment with 5+ years of experience in sourcing top talent for IT companies across India.',
  ...
  },
  {
    ...
    description: 'Rahul leads our digital marketing initiatives with expertise in SEO, SEM, and social media strategies that drive results.',
  ...
  },
  {
    ...
    description: 'Fatima manages corporate travel solutions with a focus on cost optimization and seamless travel experiences.',
  ...
  },
  {
    ...
    description: 'Arjun creates stunning, responsive websites with modern technologies including React, Node.js, and cloud platforms.',
  ...
  },
  {
    ...
    description: 'Sneha crafts compelling brand identities that resonate with target audiences and drive business growth.',
  ...
  },
  {
    ...
    description: 'Mohammed handles day-to-day HR operations including onboarding, compliance, and employee engagement programs.',
...
<div className="mb-24">
  <div className="flex items-center justify-center gap-3 mb-12">
    ...
    <h3 className="text-3xl font-bold text-white">Leadership Team</h3>
  </div>
    ...
    {leaders.map((leader, index) => (
      ...
      >
        ...
        <div className="
          ...
          backdrop-blur-2xl rounded-3xl overflow-hidden 
    ...
    {leader.expertise}
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {leader.skills?.slice(0, 3).map((skill, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 bg-red-600/20 text-red-500 text-xs rounded-full"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <motion.button
                whileHover={{ x: 6 }}
                className="flex items-center gap-1 text-red-500 font-medium text-sm"
              >
        ...
        {selectedMember && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-secondary to-secondary/90 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-white/10"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="relative">
                ...
                <div className="relative h-64 overflow-hidden rounded-t-3xl">
                  ...
                  {selectedMember.isLead && (
                    <div className="absolute top-4 left-4 flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
                      <Crown className="w-4 h-4 text-red-600" />
                      <span className="text-sm font-bold text-red-600">LEAD</span>
                    </div>
                  )}

                  {/* Name Overlay */}
                  <div className="absolute bottom-4 left-6 right-6">
                    <span className="text-primary text-sm font-medium">{selectedMember.department}</span>
                    <h3 className="text-3xl font-bold text-text-light">{selectedMember.name}</h3>
                ...
                <div className="p-6 md:p-8">
                  ...
                  {selectedMember.skills && (
                    <div className="mb-6">
                      <h4 className="text-sm font-semibold text-text-light mb-3">Expertise & Skills</h4>
                      <div className="flex flex-wrap gap-2">
                        {selectedMember.skills.map((skill, i) => (
                          <motion.span
                            ...
                            className="px-4 py-2 bg-primary/20 text-primary text-sm rounded-full font-medium"
                          >
                            {skill}
                          </motion.span>
                        ))}
                  ...
                  <div className="flex gap-3">
                    {selectedMember.social?.linkedin && (
                      <motion.a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-text-light hover:bg-primary hover:text-red-600 transition-colors"
                      >
                        <Linkedin className="w-5 h-5" />
